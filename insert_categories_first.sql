-- Insert Categories and Subcategories FIRST before importing products
-- Run this before data_insert_products_clean.sql
--
-- IMPORTANT: If you copy-paste this file, make sure to run this command FIRST:
-- SET client_encoding = 'UTF8';
--
-- Or run the entire file with: \i path/to/this/file.sql
