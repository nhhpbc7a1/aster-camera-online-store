-- SQL script to create tables from migration InitialSchema1773680170093
...
CREATE TYPE "public"."orders_paymentmethod_enum" AS ENUM('credit_card', 'debit_card', 'cash_on_delivery', 'bank_transfer');
...
-- Subcategories table (depends on categories)
CREATE TABLE "subcategories" (
    ...
    "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
    "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
    CONSTRAINT "UQ_290ef46936579a55f65f81f5e4c" UNIQUE ("slug"),
...
-- Products table (depends on categories and subcategories)
...
CREATE TABLE "orders" (
    ...
    "shippingFee" numeric(15,2) NOT NULL DEFAULT '0',
...
CREATE TABLE "carts" (
    ...
    "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
    "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
    CONSTRAINT "UQ_69828a178f152f157dcf2f70a89" UNIQUE ("userId"),
...
-- Reviews table (depends on users and products)
